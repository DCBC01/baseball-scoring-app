...
import { Calendar, MapPin, ArrowLeft, ArrowRight, Users } from 'lucide-react-native';
...
export default function NewGameScreen() {
  ...
  const handleSubmit = () => {
    if (!opponent || !date || !location || !teamId) {
          ...
          <View style={styles.teamContainer}>
            {teams.map(team => (
              <TouchableOpacity
                ...
                style={[
                  styles.teamOption,
                  teamId === team.id && styles.teamOptionSelected,
                  teamId === team.id && { borderColor: team.color }
                ]}
              ...
              >
                <Text 
                  style={[
                    styles.teamText,
                    teamId === team.id && styles.teamTextSelected,
                    teamId === team.id && { color: team.color }
                  ]}
                >
                  {team.name}
                </Text>
          ...
          >
            ...
            <Text style={styles.participantsButtonText}>
              {selectedParticipants.length > 0 
                ? `${selectedParticipants.length} players selected` 
